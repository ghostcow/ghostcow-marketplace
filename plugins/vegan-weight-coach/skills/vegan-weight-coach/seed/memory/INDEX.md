# Memory index
Read first every session (with CURRENT.md + anchor.md). Pointers + freshness only — no data.
...
## Freshness (re-confirm if stale >~30d or after a life event)
- (none yet)

## Consolidation
last: never · next due: after first week
