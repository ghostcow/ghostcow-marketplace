...
When there is no profile yet (or the user wants to redo it), gather the full set of details before building menus. It is a finite list — ask for all of it, and take the space it needs:
